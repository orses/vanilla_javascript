<<<<<<< HEAD
(() => {
  function renderResponse(userRating) {
    return `<div class="center-l">
    <div class="box-l card-result">
      <div class="stack-l">
        <div class="frame-l">
        ...
        <div class="card__rating-result">You selected ${userRating} out of 5</div>
        <h1 class="card__title text-centered">Thank you!</h1>
        <p class="card__text text-centered">
  ...
  function handleRating() {
    const btSubmit = document.querySelector('.btn.btn-cta');
    ...
    btSubmit.addEventListener('click', () => {
      ...
      if (ratingOption) {
        const userRating = ratingOption.value;
        main.innerHTML = renderResponse(userRating);
      }
    });
  }
